...
function writeTenMillionUsers(writer, encoding, callback) {
  ...
  function write() {
    ...
    do {
      ...
      let photo2 = 2 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo3 = 3 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo4 = 4 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo5 = 5 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo6 = 6 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo7 = 7 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo8 = 8 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo9 = 9 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo10 = 10 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo11 = 11 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo12 = 12 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo13 = 13 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo14 = 14 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo15 = 15 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo16 = 16 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
      let photo17 = 17 <= numPhotos ? 'https://loremflickr.com/320/240/' + housingOptions[index] : '';
